...
Here is where a React component will go:
...
Here is where a live code example will go:
...
Here is where a normal code block will go:
...
Here is where `inline code` go, just inside the text. Wow!
